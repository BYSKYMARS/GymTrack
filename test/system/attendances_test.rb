...
class AttendancesTest < ApplicationSystemTestCase
  ...
  test "should create attendance" do
    ...
    fill_in "Attended at", with: @attendance.attended_at
    fill_in "Class session", with: @attendance.class_session_id
  ...
  test "should update Attendance" do
    ...
    fill_in "Attended at", with: @attendance.attended_at.to_s
    fill_in "Class session", with: @attendance.class_session_id
    fill_in "User", with: @attendance.user_id
